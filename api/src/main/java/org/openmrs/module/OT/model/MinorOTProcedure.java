...
public class MinorOTProcedure implements Serializable {
	...
	public Integer getMinorOTId() {
		return minorOTId;
	}
	public void setMinorOTId(Integer minorOTId) {
		this.minorOTId = minorOTId;
	}
