...
package org.openmrs.module.OT.web.controller.majorOT;
...
*
*/
@Controller("MajorOTHeaderController")
@RequestMapping("/module/OT/majorOT.form")
public class MajorOTHeaderController {
	...
	public String main(Model model) {
		...
		return "/module/OT/majorOT/majorOT";
	}
