...
package org.openmrs.module.OT.web.controller.minorOT;
...
*
*/
@Controller("MinorOTHeaderController")
@RequestMapping("/module/OT/minorOT.form")
public class MinorOTHeaderController {
	...
	public String main(Model model) {
		...
		return "/module/OT/minorOT/minorOT";
	}
