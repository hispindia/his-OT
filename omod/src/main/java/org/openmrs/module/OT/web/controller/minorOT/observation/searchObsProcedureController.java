...
@Controller("MinorOTSearchObsProcedureController")
@RequestMapping("/module/OT/searchObsProcedure.form")
public class searchObsProcedureController {
	...
	public String searchTest(
		...
		try {
			...
			if (currentPage == null)
				currentPage = 1;	
			List<MinorOTProcedure> otSchedules = ots.getMinorOTSchedules(date, phrase, procedures, 
					currentPage);
			List<OTScheduleModel> otProcedures = OperationTheatreUtilMinor.generateObsModelsFromSchedules(
					otSchedules);
