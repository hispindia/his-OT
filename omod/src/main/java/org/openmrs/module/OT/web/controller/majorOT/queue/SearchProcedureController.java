...
package org.openmrs.module.OT.web.controller.majorOT.queue;
...
@Controller("MajorOTSearchProcedureController")
@RequestMapping("/module/OT/searchProcedureMajor.form")
public class SearchProcedureController {
	...
	public String searchTest(
		...
		try {
			...
			if (currentPage == null)
				currentPage = 1;	
			List<OpdTestOrder> schedules = ots.getSchedulesMajorOT(date, phrase, procedures, 
					currentPage);
			List<OTScheduleModel> otProcedures = OperationTheatreUtil_Major.generateModelsFromSchedules(
					schedules);
