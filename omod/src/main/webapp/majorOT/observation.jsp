...
<br/>
<openmrs:require privilege="Access Major OT" otherwise="/login.htm" redirect="/module/OT/observation.form" />
...
<script type="text/javascript">
	...
	function getProcedures(currentPage){
		...
		jQuery.ajax({
			type : "GET",
			url : getContextPath() + "/module/OT/searchObsProcedureMajor.form",
			data : ({
				date			: date,
				phrase			: phrase,
				procedure		: procedure,
	...
	function observationProcedure(orderId, observations) {
		jQuery.ajax({
			type : "POST",
			url : getContextPath() + "/module/OT/observationProcedureMajor.form",
			data : ({
				orderId : orderId,
